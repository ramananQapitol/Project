...
////tags= {"@tag,@tag1,@tag2,@tag3,@tag4,@tag5,@tag6,@tag7,@tag8,@tag9,@tag10,@tag11,@tag12,@tag13,@tag14,@tag15,@tag16,@tag17,@tag18,@tag19,@tag20, @tag21,@tag22"}
//tags= {"@tag,@tag1,@tag2,@tag3,@tag5,@tag6,@tag7,@tag8,@tag9,@tag10,@tag11,@tag12,@tag13,@tag14,@tag15,@tag16,@tag17,@tag18,@tag19,@tag20, @tag21"},
...
tags= {"@tag45"},monochrome=true,dryRun=false,snippets = SnippetType.CAMELCASE,
plugin = {"pretty","html:test-output"})
